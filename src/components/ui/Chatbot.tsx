...
export default function ChatBot({
  ...
  return (
          ...
          >
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <div className="flex flex-col ml-4">
                    <h3 className="font-semibold text-base text-blue-600 leading-none">
                      {title}
                    </h3>
            ...
            <ScrollArea className="flex-1 px-4 relative z-0 overflow-hidden">
              <div className="flex flex-col justify-start space-y-4 mt-4 -pb-4 -mb-8">
                <div className="flex flex-col items-center justify-center mb-6 text-blue-400">
                  {/* <Avatar
                  ...
                  <p className="font-normal my-2"> answers instantly</p> */}
    ...
    ${
      message.role === 'user'
        ? 'bg-gradient-to-r from-blue-700 to-sky-800 text-blue-100 ml-8'
        : 'bg-gradient-to-r from-blue-500 to-sky-600 text-white mr-8 font-light font-inter text-md'
    }
  `}
                        >
                          {message.content}
                    ...
                    {showTimestamp &&
                      ...
                      message.role === 'assistant' && (
                        <div className="text-xs text-muted-foreground mt-1 text-left ml-11 mb-4">
                          Bot · <TimeAgoComponent date={message.createdAt} />.
                        </div>
                      )}
                  </div>
                ))}
...
const TimeAgoComponent = ({ date }: { date: Date | string }) => {
